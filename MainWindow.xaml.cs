...
public partial class MainWindow : Window
{
    ...
    private async void MainWindow_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        Ipc.TimePosChanged += pos => Dispatcher.Invoke(() => _overlay?.UpdateTime(pos));
        Ipc.DurationChanged += dur => Dispatcher.Invoke(() => _overlay?.UpdateDuration(dur));
